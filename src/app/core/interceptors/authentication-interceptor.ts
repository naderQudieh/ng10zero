...
export class AuthenticationInterceptor implements HttpInterceptor {
  ...
  constructor( private authService: AuthService) {
    ...
    private handle401Error(request: HttpRequest<any>, next: HttpHandler, tokens: AuthToken): Observable<any> {
    ...
    private continueWithoutRefreshing(request: HttpRequest<any>, next: HttpHandler, tokens: AuthToken): Observable<any> {
    ...
    private addTokensToHeader(request: HttpRequest<any>, tokens: AuthToken) {
