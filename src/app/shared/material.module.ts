...
export const MATERIAL_MODULES_CORE = [MatDialogModule, MatBadgeModule,
  ...
  MatSidenavModule, MatStepperModule,
    MatListModule,
    MatTooltipModule,
  MatSelectModule, ScrollingModule, OverlayModule,
    MatSnackBarModule, FlexLayoutModule,
  MatButtonModule, MatDatepickerModule, MatSortModule,
  MatNativeDateModule, MatExpansionModule, MatButtonToggleModule, MatAutocompleteModule
];
